...
def validLength(data_fn):
    ...
    if data_point["audio_feat"].shape[1] >= n_sample_frames: 
        print(data_point["audio_feat"].shape[1] >= n_sample_frames, data_point["audio_feat"].shape[1], n_sample_frames)
        return data_fn
    else: return -1
...
json_fn = args['data_train_unfiltered']
