...
config_library = {
    "multilingual": "yoruba_config.json",
    "multilingual+matchmap": "yoruba_config.json",
    "english": "yoruba_config.json",
    "english+matchmap": "yoruba_config.json",
    "hindi": "yoruba_config.json",
    "hindi+matchmap": "yoruba_config.json",
}
...
def modelSetup(parser, test=False, make_model_files=True):
    ...
    if "feat" in parser:
        ...
        feat = None
    if test or resume: make_model_files = False
    # if make_model_files is False:
    ...
    if os.path.isfile(args["exp_dir"] / config_library[config_file]) is False and make_model_files:
